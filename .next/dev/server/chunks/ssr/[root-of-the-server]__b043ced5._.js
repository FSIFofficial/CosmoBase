...
"[project]/lib/partners.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const getPartners = ()=>{
    const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'data/partners.csv');
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$partners$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/partners.ts [app-rsc] (ecmascript)");
;
;
;
;
...
async function generateStaticParams() {
    const partners = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$partners$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPartners"])();
    return partners.map((partner)=>({
            id: partner.id
        }));
}
async function PartnerDetailPage({ params }) {
    const { id } = await params;
    const partner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$partners$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPartnerById"])(id);
    if (!partner) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b043ced5._.js.map