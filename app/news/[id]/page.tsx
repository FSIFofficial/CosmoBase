      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <div className="text-[#EEEEFF]/90 font-sans leading-relaxed whitespace-pre-wrap　[&_ul]:list-inside [&_ul]:pl-6 [&_ol]:list-inside [&_ol]:pl-6 space-y-4" style={{lineHeight:"1.8"}} dangerouslySetInnerHTML={{ __html: article.content}} />
          </div>
